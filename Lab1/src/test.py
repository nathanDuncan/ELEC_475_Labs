...
def autoencoder_test(save_file=None, bottleneck_size=0, noise=False, sets=3):
    """
    Step 4
...
def bottleneck_interpolation(save_file=None, sets=3, interpolation_steps=8):
    """
    ...
    """
    print('[INFO] Step 6: Testing interpolation...')
...
if __name__ == '__main__':
    ...
    visualize_MNIST_img()
    # Run Step 4
    autoencoder_test(save_file, bottleneck_size, noise=False)
    # Run Step 5
    autoencoder_test(save_file, bottleneck_size, noise=True)
    # Run Step 6
    bottleneck_interpolation(save_file)
